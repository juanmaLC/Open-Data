        ...
        html.Div(id='superior',children=[
            ...
            html.Div(children=[
                ...
                html.Ul(id='menu', children=[
                    ...
                    html.Li(html.A(i,href='/',target='_blank')) for i in opciones
        ...
        html.Div(children=[
            ...
            html.Div(children=[
                ...
                html.Div(id='titulo',children=[
                    ...
                    html.A('Estadísticas OpenData',href=''),
                ...
                html.Div(id='imagen',children=[
                    ...
                    html.A(html.Img(src="assets/logo-ugr-negativo.svg",alt="imagen corporativa UGR"),href='https://www.ugr.es',target='_blank'),
            ...
            html.Div(id='footerSuperior',children=[
                ...
                html.Div(id='col1',children=[
                    ...
                    html.Div(children=[
                        ...
                        html.A(html.Img(src="assets/osl_logo_negativo.svg",alt="imagen corporativa OSL"),href='https://osl.ugr.es/',target='_blank'),
                ...
                html.Div(id='col2',children=[
                    ...
                    html.Ul(children=[
                        ...
                        html.Li(
                            html.A('Portal Open Data',href='/',target='_blank'),
                        ),

                        html.Li(
                            html.A('Catálogo de datos',href='',target='_blank'),
                        ),

                        html.Li(
                            html.A('SPARQL',href='',target='_blank'),
                        ),
